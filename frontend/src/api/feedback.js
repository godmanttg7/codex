...
export const getFacilities = () => request('/manage/facilities')
...
export const assignRepair = (id, assigneeName) => request(`/manage/repairs/${id}/assign`, { method: 'PATCH', body: JSON.stringify({ assigneeName }) })
export const updateRepairStatus = (id, status) => request(`/manage/repairs/${id}/status`, { method: 'PATCH', body: JSON.stringify({ status }) })
export const cancelRepair = (id) => request(`/manage/repairs/${id}/cancel`, { method: 'PATCH' })
export const deleteRepair = (id) => request(`/manage/repairs/${id}`, { method: 'DELETE' })
export const getConsumables = () => request('/manage/consumables')
export const getMessages = () => request('/manage/messages')
